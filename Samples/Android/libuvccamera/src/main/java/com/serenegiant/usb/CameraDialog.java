...
public class CameraDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
	    ...
	    builder.setNeutralButton(R.string.refresh, mOnDialogClickListener);
			...
			if (convertView instanceof CheckedTextView) {
				...
				if (device.getProductName() != null){
					((CheckedTextView)convertView).setText(
							String.format(device.getProductName(), device.getVendorId(), device.getProductId(), device.getDeviceName()));
				} else if (device.getManufacturerName() != null) {
					((CheckedTextView)convertView).setText(
						String.format(device.getManufacturerName(), device.getVendorId(), device.getProductId(), device.getDeviceName()));
				} else {
					((CheckedTextView)convertView).setText(
//						String.format("UVC Camera:(%x:%x:%s)", device.getVendorId(), device.getProductId(), device.getDeviceName()));
						String.format(device.getDeviceName(), device.getVendorId(), device.getProductId(), device.getDeviceName()));
				}
