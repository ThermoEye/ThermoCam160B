...
static jint nativeConnect(JNIEnv *env, jobject thiz,
    ...
    LOGI("nativeConnect!!!!!!!!!!!!!!!! %d", id_camera);
    LOGI("nativeConnect!!!!!!!!!!!!!!!! %d", vid);
    LOGI("nativeConnect!!!!!!!!!!!!!!!! %d", pid);
    LOGI("nativeConnect!!!!!!!!!!!!!!!! %d", fd);
    LOGI("nativeConnect!!!!!!!!!!!!!!!! %d", busNum);
    LOGI("nativeConnect!!!!!!!!!!!!!!!! %d", devAddr);
    LOGI("nativeConnect!!!!!!!!!!!!!!!! %s", usbfs_str);
...
static jint nativeStartPreview(JNIEnv *env, jobject thiz,
    ...
    __android_log_print(ANDROID_LOG_ERROR, "nativeStartPreview", "%d", id_camera);
